...
public class RuleNode extends PropositionNode {
    ...
    public void applyRuleHandler(Report report) throws NoSuchTypeException {
        ...
        for (Channel outAntChannel : outgoingRuleConsChannels) {
            sendReport(report, outAntChannel);
                    ...
                    if (!supported(currentReportContextName, 0)
                        ...
                        if (supported(currentReportContextName, 0)) {
                            ...
                            if (currentReport.getReportType() == ReportType.WhenRule) {
                                ...
                                // inference.
                                currentReport.getSupport().addNode(0, this);
    ...
    public void grandparentMethodRequest(Request currentRequest) throws NoSuchTypeException, DirectCycleException {
        super.processSingleRequests(currentRequest);
    }
