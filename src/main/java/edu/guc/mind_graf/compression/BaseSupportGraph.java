...
public class BaseSupportGraph {
    ...
    public BaseSupportGraph(int sizeV1, int sizeV2, boolean[] removed, HashSet<Integer>[] adj, HashSet<Integer>[] adjRev) {
        this.sizeV1 = sizeV1;
        this.sizeV2 = sizeV2;
    ...
    public BaseSupportGraph(int sizeV1, int sizeV2, double edgeDensity) {
        this(sizeV1, sizeV2);
    ...
    public BaseSupportGraph(int sizeV1, int sizeV2) { // create empty graph
        this.sizeV1 = sizeV1;
        this.sizeV2 = sizeV2;
    ...
    public BaseSupportGraph copy() {
        ...
        return new BaseSupportGraph(sizeV1, sizeV2, removed.clone(), adjclone, adjRevclone);
    }

    public static void main(String[] args) {
        BaseSupportGraph g = new BaseSupportGraph(4, 4);
        g.addEdge(0, 7);
        g.addEdge(1, 5);
        g.addEdge(1, 7);
        g.addEdge(2, 4);
