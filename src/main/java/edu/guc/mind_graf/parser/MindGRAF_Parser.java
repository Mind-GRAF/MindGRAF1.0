...
public class MindGRAF_Parser implements MindGRAF_ParserConstants {
  ...
  // Define the grammar
  final public Node Expression() throws ParseException, ParseException {
    Node result = null;
  ...
  final public Node Act() throws ParseException, ParseException {
    Node act = null;
    switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
      case 30: {
        act = SNSequence();
  ...
  final public Node SNSequence() throws ParseException, ParseException {
  ...
  final public Node Attitude() throws ParseException, ParseException {
    Node prop = null;
    jj_consume_token(31);
    prop = Expression();
    jj_consume_token(25);
  ...
  final public Node Achieve() throws ParseException, ParseException {
    Node prop = null;
    jj_consume_token(32);
    prop = Expression();
    jj_consume_token(25);
  ...
  final public Node DoOne() throws ParseException, ParseException {
  ...
  final public Node DoAll() throws ParseException, ParseException {
    HashMap<String, Node> hashedNodes = new HashMap<String, Node>();
    Node oneAct;
    jj_consume_token(34);
    oneAct = Act();
  ...
  final public Node GuardedAct() throws ParseException, ParseException {
    Node actNode = null;
    Node prop = null;
    jj_consume_token(35);
    actNode = Act();
  ...
  final public Node SNIF() throws ParseException, ParseException {
  ...
  final public Node SNIterate() throws ParseException, ParseException {
    Node oneGuardAct = null;
    HashMap<String, Node> allGuardActs = new HashMap<String, Node>();
    jj_consume_token(37);
    oneGuardAct = GuardedAct();
  ...
  final public void DescribeContext() throws ParseException, ParseException {
    ...
    for(ArrayList<String> contexts : wffs.values()){
      ...
      for(int i = 1;i<contexts.size();i++){
        ...
        System.out.prin
        if(cxt.substring(0,cxt.length()-1).equals(CName));
  ...
  final public void RemoveFromContext() throws ParseException, ParseException {
    ...
    controller.removeFromContext(CName, controller.getAttitudeNumber(attitude.trim()), node.getId());
    ArrayList<String> contexts = wffs.get(node.getId());
    contexts.remove(CName + attNum);
    if (contexts.size() == 0)
  ...
  final public void AddToContext() throws ParseException, ParseException {
    ...
    if (wffs.containsKey(node.getId())) {
      ...
      for (int i = 1; i < wffName.size(); i++) {
        if (wffName.get(i).equals(CName + attNum)) {
          if (true) {
            if (true)
              throw new ParseException("Already Supported in Context " + CName + " in attitude " + attitude);
          }
        }
      }
    }
    ...
    if (wffs.containsKey(node.getId())) {
      ArrayList<String> wffName = wffs.get(node.getId());
      wffName.addLast(CName + attNum);
    } else {
      ArrayList<String> list = new ArrayList<String>();
      list.add("wff" + (wffs.size() + 1));
      list.add(CName + attNum);
  ...
  final public void teleAttitudeList() throws ParseException, ParseException {
    Token attitude;
    jj_consume_token(29);
  ...
  final public void OneAttitudeInTeleList() throws ParseException, ParseException {
    Token attitude;
    attitude = jj_consume_token(STRING);
  ...
  final public void consequenceAttitudeList() throws ParseException, ParseException {
    Token attitude;
    jj_consume_token(29);
  ...
  final public void OneAttitudeInConsequenceList() throws ParseException, ParseException {
    Token attitude;
    attitude = jj_consume_token(STRING);
    String s = attitude.image.trim().toLowerCase();
    if (!initialAttitudes.containsKey(s)) {
  ...
  final public void conjunctionAttitudeList() throws ParseException, ParseException {
    Token attitude;
    jj_consume_token(29);
  ...
  final public void OneAttitudeInConjunctionList() throws ParseException, ParseException {
    Token attitude;
    attitude = jj_consume_token(STRING);
    String s = attitude.image.trim().toLowerCase();
    if (!initialAttitudes.containsKey(s)) {
  ...
  private static void jj_la1_init_0() {
    jj_la1_0 = new int[] { 0x20c38000, 0x20008000, 0x20808000, 0x1000000, 0xc0000000, 0x1000000, 0x1000000, 0x1000000,
        0x1000000, 0x1000000, 0x1000000, 0x80000, 0x20e38000, 0x1000000, 0x7c0, 0x7c0, 0x200000, 0x1000000, 0x0,
        0x2f280020, 0x2f280020, 0x1000000, 0x200020, 0x1000000, 0x1000000, 0x800, 0x20000000, 0x1000000, 0x20000000,
        0x1000000, 0x20000000, 0x1000000, 0x20000000, 0x1000000, };
  }

  private static void jj_la1_init_1() {
    jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x3f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3f9c0, 0x0,
        0x0, 0x200, 0xfff80600, 0xfff80600, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
  }

  private static void jj_la1_init_2() {
    jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800, 0x800, 0x0, 0x0,
        0x0, 0x1ff, 0x1ff, 0x0, 0x0, 0x0, 0x0, 0x400, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
  }
