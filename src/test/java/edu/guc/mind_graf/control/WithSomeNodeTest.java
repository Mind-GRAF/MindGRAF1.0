...
//        new Network();
    ...
    void test1(){
        try {
			...
			Node toy = Network.createNode("toy", "propositionnode");
			...
			Node withsome = Network.createNode("WithSome", "individualnode");
			...
			Relation test = Network.createRelation("test", "", Adjustability.NONE, 0);

            DownCable d1 = new DownCable(obj, new NodeSet(toy));
			...
			DownCable d8 = new DownCable(action, new NodeSet(withsome));
            ...
            DownCable d6 = new DownCable(test, new NodeSet(M0));
            DownCable d7 = new DownCable(obj, new NodeSet(actNode));

            WithSomeNode M3 = new WithSomeNode(new DownCableSet(d8,d5,d6,d7));
