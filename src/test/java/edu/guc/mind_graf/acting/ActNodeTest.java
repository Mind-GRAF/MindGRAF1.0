...
public class ActNodeTest {
   ...
   void setUp() throws NoSuchTypeException {
       ...
       IndividualNode window=(IndividualNode)Network.createNode("window", "individualnode");
       ...
       IndividualNode open=(IndividualNode)Network.createNode("open", "individualnode");
       IndividualNode illuminate=(IndividualNode)Network.createNode("illuminate", "individualnode");
       ...
       DownCable objectCable5=new DownCable(objectRelation, new NodeSet(window));
       ...
       DownCable actionCable5=new DownCable(actionRelation, new NodeSet(open));
       DownCable actionCable6=new DownCable(actionRelation, new NodeSet(illuminate));
       ...
       DownCableSet actionobj6=new DownCableSet(objectCable3,actionCable6);
       ...
       M6=(ActNode)Network.createNode("actnode", actionobj6);
       M7=(ActNode)Network.createNode("actnode", actionobj5);
