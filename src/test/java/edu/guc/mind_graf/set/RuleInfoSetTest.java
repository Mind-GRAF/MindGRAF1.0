...
class RuleInfoSetTest {
    ...
    public void testAddRuleInfo() {
        RuleInfo ruleInfo = new RuleInfo("", 0, 1, 2, new Substitutions(), new FlagNodeSet(), new Support(-1));
    ...
    public void testCombine() throws DirectCycleException {
        ...
        RuleInfo ruleInfo3 = new RuleInfo("", 0, 2, 2, new Substitutions(), new FlagNodeSet(), new Support(-1));
