...
class RuleInfoSetTest {
    ...
    public void testAddRuleInfo() {
        RuleInfo ruleInfo = new RuleInfo(1, 2, new Substitutions(), new FlagNodeSet());
    ...
    public void testCombine() {
        ...
        RuleInfo ruleInfo3 = new RuleInfo(2, 2, new Substitutions(), new FlagNodeSet());
    ...
    public void testCombineAdd() {
        RuleInfoSet ruleInfoSet1 = new RuleInfoSet(new RuleInfo(1, 2, new Substitutions(), new FlagNodeSet()));
        RuleInfo ruleInfo = new RuleInfo(2, 1, new Substitutions(), new FlagNodeSet());
    ...
    public void testUnion() {
        RuleInfoSet ruleInfoSet1 = new RuleInfoSet(new RuleInfo(1, 2, new Substitutions(), new FlagNodeSet()));
        RuleInfoSet ruleInfoSet2 = new RuleInfoSet(new RuleInfo(2, 1, new Substitutions(), new FlagNodeSet()));
