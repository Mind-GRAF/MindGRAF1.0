...
public class MyClassCreator {
    ...
    public static void start(String className, String superClassName, String methodName, String methodCode,
            Class<?> constructorParam, Object constructorArg)
    ...
    public static Class<?> createClass(String className, String classCode, String fileName, String superClassName)
    ...
    public static Class<?> createClass4(String className, String superClassName, List<String> fieldTypes,
            List<String> fieldNames, List<String> constructorParamTypes, List<String> constructorParamNames)
            throws IOException, ClassNotFoundException {
    ...
    static class Compiler {
        public byte[] compile(String className, String code) throws Exception {
            ...
            fileManager.close();
            return Files
                    .readAllBytes(Paths.get(compiledClass.getProtectionDomain().getCodeSource().getLocation().toURI())
