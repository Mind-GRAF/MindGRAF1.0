...
public class NumEntail extends RuleNode{
    private static int min;
    private static int max;
    private static int i;

    public NumEntail(String name, Boolean isVariable){
        super(name, isVariable);
    }

    public NumEntail(DownCableSet downCableSet) {
        super(downCableSet);
    }
    ...
    protected RII findMatchingRII(Report report){
        return super.findMatchingRII(report);
    }
